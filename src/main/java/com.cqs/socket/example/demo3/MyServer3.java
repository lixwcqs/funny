...
public class MyServer3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            serverSocketChannel.socket().bind(new InetSocketAddress(10006));
    ...
    private static void execute(ServerSocketChannel serverSocketChannel) throws IOException {
        ...
        try {
            ...
            Film film = receiveData(socketChannel);
    ...
    private static Film receiveData(SocketChannel socketChannel) throws IOException {
        Film film = null;
